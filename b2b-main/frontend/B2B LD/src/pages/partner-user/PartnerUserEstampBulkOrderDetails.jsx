...
const PartnerUserEstampBulkOrderDetails = () => {
          ...
          <section className="rounded-lg p-6 space-y-2 text-sm" style={card}>
            ...
            {bulk && (
              <>
                ...
                {/* eStamp Bulk has no Base Price of its own — Service Fee is
                    always 0 for orders placed after that change and hidden
                    here, exactly like a ₹0 additional charge below. Orders
                    placed before it keep showing their real historical fee
                    (see create_bulk_estamp_order), unaffected by any config
                    change since. */}
...
export default PartnerUserEstampBulkOrderDetails;
