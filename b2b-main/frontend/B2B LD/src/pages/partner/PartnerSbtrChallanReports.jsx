...
const PartnerSbtrChallanReports = () => {
  ...
  useEffect(() => {
    ...
    apiRequest(`/api/partner/reports/sbtr-challans${query}`)
      .then(setRecords)
      .catch(() => setRecords([]))
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm mt-1" style={{ color: "#5B7285" }}>SBTR and challan records for your organization</p>
      </div>
      ...
      <div className="rounded-2xl p-4 mb-5 flex flex-wrap gap-3 items-center" style={card}>
        <div className="relative flex-1 min-w-48">
          ...
          <input type="text" placeholder="Search GTN, challan, user, customer..." value={search} onChange={(e) => setSearch(e.target.value)}
          ...
          <table className="w-full">
            <thead>
              <tr style={{ background: "#F3F8FB", borderBottom: "1px solid #D8E6F0" }}>
                {["GTN Number", "Challan Number", "User Name", "Customer Name", "State", "Address", "Status", "Created Date"].map((h) => (
            ...
            <tbody>
              ...
              {loading && (
                <tr>
                  <td colSpan="8" className="text-center py-16 text-sm" style={{ color: "#5B7285" }}>Loading records...</td>
                </tr>
              )}
            </tbody>
          </table>
...
export default PartnerSbtrChallanReports;
